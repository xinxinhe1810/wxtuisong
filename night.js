...
const getWanan = async () => {
  //需要安装request模块
  const res = await request.get("http://api.tianapi.com/wanan/index", {
    params: {
      key: tianqiAppkey,
    },
  });
...
// 明日天气：{{weather.DATA}} 
// 明日风力: {{windspeed.DATA}}
// 明日最低气温: {{min_temperature.DATA}} 
// 明日最高气温: {{max_temperature.DATA}} 
// 明日降雨概率：{{pop.DATA}}% 
// 我们恋爱{{love_day.DATA}}天
